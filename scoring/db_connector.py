...
# 2024-01-01 | 최초 구현 | DB 연결 및 데이터 접근 구현 | AI Assistant
# ----------------------------------------------------------------------------------------------------
...
class DBConnector:
    def __init__(self):
        self.DATABASE_URL = "mysql+pymysql://root:Skala25a!23$@a1961fab471c6487aa7b3f049f61cdf7-770154099.ap-northeast-2.elb.amazonaws.com:3306/sk-team-12"
